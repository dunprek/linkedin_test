...
import com.don.linkedin_test.model.ApiClient;
import com.don.linkedin_test.model.Person;
...
//These are constants used for build the urls
    ...
    private class PostRequestAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            pd = ProgressDialog.show(LinkedActivity.this, "", LinkedActivity.this.getString(R.string.loading), true);
        }
                    ...
                    if (response != null) {
                        ...
                        if (response.getStatusLine().getStatusCode() == 200) {
                            ...
                            if (expiresIn > 0 && accessToken != null) {
                                ...
                                SharedPreferences preferences = LinkedActivity.this.getSharedPreferences("user_info", 0);
                                SharedPreferences.Editor editor = preferences.edit();
                                editor.putLong("expires", expireDate);
                                editor.putString("accessToken", accessToken);
                                editor.commit();

                                getLinkedInPerson(accessToken);
        ...
        protected void onPostExecute(Boolean status) {
            ...
            if (status) {
                ...
                Intent startProfileActivity = new Intent(LinkedActivity.this, MainActivity.class);
                //  LinkedActivity.this.startActivity(startProfileActivity);
